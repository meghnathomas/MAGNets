...
random.seed(1) # Change the value in brackets to generate different randomized results for comparison
random.shuffle(junc_name_list)
    
for i in range(quad_1):
    list_1.append(junc_name_list[i])
    list_2.append(junc_name_list[i])
    list_3.append(junc_name_list[i])
...
print('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
print('Randomly ordered list of nodes to keep')
print('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
